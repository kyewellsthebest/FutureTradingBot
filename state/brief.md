RESEARCH BRIEF  2026-08-19T12:23:45+00:00
573,246 trials charged, 0 survivor(s)
...
WHAT THE COVERAGE ACTUALLY BUYS
  423,482 cells measured
  200,304 could have seen an edge worth having
  30,464 could not -- their silence means nothing
  smallest edge ever visible anywhere: 0.013 RT/trade

NOT TESTED -- COULD NOT BE ASKED
  day_of_month/vol: 25,156/50,818 (50%) unevaluable
  day_of_month/n: 24,378/49,710 (49%) unevaluable
  day_of_month/absret: 14,434/31,327 (46%) unevaluable
  minute_of_day/absret: 154,268/340,712 (45%) unevaluable
  minute_of_day/vol: 207,590/475,161 (44%) unevaluable
  minute_of_day/n: 205,017/475,176 (43%) unevaluable
...
GENUINELY RULED OUT
  shape/squeeze: 29,363 cells -- edges above 0.013 RT are excluded here
  shape/inside: 31,258 cells -- edges above 0.014 RT are excluded here
  shape/close_high: 34,988 cells -- edges above 0.016 RT are excluded here
  shape/expansion: 32,284 cells -- edges above 0.020 RT are excluded here
...
QUESTIONS ANSWERED WHILE YOU WERE AWAY
  cost_breakeven  (4 run(s))
      Q: How high can the all-in round turn go before the best thing the search has found stops paying?
      A: the best cell of 262,655 pays +47.490 round trips over 2,695 trades, which breaks even at an all-in round turn of $29.09 on MNQ (the search charged $0.60). after shrinking for the winner's curse it breaks even at $0.60. the 99th percentile of ALL 262,655 cells breaks even at $0.61 and the median at $-0.01, so the winner's headroom over the modelled cost is 2521.60x what the 99th percentile of the pile gets for free. at 258 trades a week it is worth the ladder in the report; the practical reading is that anything above $29.09 a round turn makes this a losing system no matter how it is executed
  session_split  (4 run(s))
      Q: Is the overnight session different enough from RTH that searching and pricing them together is wrong?
      A: overnight moves are 0.69x RTH in dispersion (a random split of the same sizes gives 1.02x, so the session effect is 15x what splitting nothing produces) overnight bars are 0.45x the RTH range, which says nothing about cost -- a quiet market can still be expensive to cross MEASURED on NQ top-of-book: spread is 3.0 ticks in RTH and 5.0 overnight (1.67x wider), against a cost model that charges 1 tick for both -- overnight results ARE optimistic, and 70% of the tier-1 tape is overnight

NEXT
  [1] make day_of_month/vol expressible, or drop it
      because 25,156 of 50,818 attempts could not be asked, so this family is counted as explored and has not been
  [1] make day_of_month/n expressible, or drop it
      because 24,378 of 49,710 attempts could not be asked, so this family is counted as explored and has not been
  [1] make day_of_month/absret expressible, or drop it
      because 14,434 of 31,327 attempts could not be asked, so this family is counted as explored and has not been
  ...
  [4] stop re-testing shape/squeeze
      because 29,363 cells there already exclude edges above 0.013 RT