#!/bin/bash
# Round 16 supervisor: restarts the search if it dies.
set -u
cd /home/user/HFTBot
LOG=/home/user/HFTBot/research/round16.log
ERR=/home/user/HFTBot/research/round16.err
RESULTS=/home/user/HFTBot/research/round16_results.md
...
while [ $i -lt $MAX_RESTARTS ]; do
    ...
    /usr/bin/env python3 /home/user/HFTBot/research/round16_search.py \
        >>"$LOG" 2>>"$ERR"
    rc=$?
