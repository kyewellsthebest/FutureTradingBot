#!/bin/bash
# Round 18 supervisor: restart the search up to N times if it dies.
set -u
cd /home/user/HFTBot
LOG=/home/user/HFTBot/research/round18.log
ERR=/home/user/HFTBot/research/round18.err
RESULTS=/home/user/HFTBot/research/round18_results.md
...
while [ $i -lt $MAX_RESTARTS ]; do
    ...
    /usr/bin/env python3 /home/user/HFTBot/research/round18_search.py \
        >>"$LOG" 2>>"$ERR"
    rc=$?
