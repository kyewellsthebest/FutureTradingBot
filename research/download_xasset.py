"""Download cross-asset history that leads NQ: ES (S&P), ZB (30y bonds),
GC (gold) as front-month-stitched futures at 1-SECOND resolution, and the
VIX index at 1-minute (finest an index publishes).

1-second is the finest retail-EXECUTABLE resolution; below ~1s, ES->NQ
lead-lag is HFT and un-fillable for retail. It is also a superset of any
slower bar (resample down freely) and completes within a temp key's life,
unlike a full tick pull.
